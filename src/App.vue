    ...
    <b-navbar toggleable="lg" type="dark" style="z-index: 1000; padding-right: 20px; background-color: rgb(36, 41, 47); position: -webkit-sticky; position: sticky; top: 0px;">
      ...
      <b-collapse id="nav-collapse" is-nav style="justify-content: space-between; font-size: x-large;">
        ...
        <b-navbar-nav v-if="$store.getters.isLogin" style="display: flex;">
          ...
          <b-nav-item href="#" style="margin: auto;"><button class="nav-link" @click="logOut" style="background-color: rgb(36, 41, 47); border: none; transform: none;">LogOut</button></b-nav-item>
        </b-navbar-nav>
